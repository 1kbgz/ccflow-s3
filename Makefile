...
lint-py:  ## lint python with ruff
	python -m ruff check ccflow_s3
	python -m ruff format --check ccflow_s3
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ccflow_s3
	python -m ruff format ccflow_s3
...
test:  ## run python tests
	python -m pytest -v ccflow_s3/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ccflow_s3/tests --cov=ccflow_s3 --cov-report term-missing --cov-report xml
